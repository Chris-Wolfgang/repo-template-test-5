...
[![GitHub](https://img.shields.io/badge/GitHub-Repository-181717?logo=github)](https://github.com/Chris-Wolfgang/repo-template-test-5)
...
```bash
dotnet add package Wolfgang.RepoTest5.Nuget
```
...
- **GitHub Repository:** [https://github.com/Chris-Wolfgang/repo-template-test-5](https://github.com/Chris-Wolfgang/repo-template-test-5)
- **API Documentation:** https://Chris-Wolfgang.github.io/repo-template-test-5/
...
git clone https://github.com/Chris-Wolfgang/repo-template-test-5.git
cd repo-template-test-5
