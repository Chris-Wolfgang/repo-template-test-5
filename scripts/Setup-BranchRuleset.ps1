...
param(
    [Parameter()]
    [string]$Repository = "@Chris-Wolfgang/repo-template-test-5",
...
if ($Repository -eq "@Chris-Wolfgang/repo-template-test-5" -or -not $Repository) {
    ...
    try {
        ...
        if ($Repository -eq "@Chris-Wolfgang/repo-template-test-5") {
